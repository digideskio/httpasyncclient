...
class MinimalClientExchangeHandlerImpl<T> extends AbstractClientExchangeHandler {
    ...
    void releaseResources() {
        try {
            ...
            getLog().debug("I/O error closing request producer", ex);
        }
        try {
            this.responseConsumer.close();
        } catch (final IOException ex) {
            getLog().debug("I/O error closing response consumer", ex);
        }
    }
    ...
    public void start() throws HttpException, IOException {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug("[exchange: " + getId() + "] start execution");
        }
    ...
    public void produceContent(
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug("[exchange: " + getId() + "] produce content");
        }
    ...
    public void requestCompleted() {
        if (getLog().isDebugEnabled()) {
            getLog().debug("[exchange: " + getId() + "] Request completed");
        }
    ...
    public void responseReceived(
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug("[exchange: " + getId() + "] Response received " + response.getStatusLine());
        }
    ...
    public void consumeContent(
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug("[exchange: " + getId() + "] Consume content");
        }
    ...
    public void responseCompleted() throws IOException, HttpException {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug("[exchange: " + getId() + "] Response processed");
        }
        try {
            markCompleted();
            releaseConnection();
